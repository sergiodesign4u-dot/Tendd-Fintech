...
- All five aspirational products: they are benchmarks for trust and clarity, not purchase alternatives, so they inform the trust benchmark (research/docs/benchmark.md) rather than this head-to-head matrix.
