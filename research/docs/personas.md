...
**Built on:** research/docs/research.md (v_refresh, June 2026), research/docs/strategy.md, research/docs/ux-patterns.md, research/docs/competitors.md, and post-sprint targeted web research (June 2026).
...
### 1B. What Drives Them - Financial Anxiety Data
...
### 1C. What They Fear - The Trust Barrier
...
Source: research/docs/competitors.md P1
...
### Persona 1 (PRIMARY): Emma, 29 - The Anxious Non-Looker
...
Source: research.md J4; behavior pattern BP3 (O24)
...
P2: Cryptic transaction names. When she does look, she sees "SPOTIFYAB STOCKHOLM" and "DCSF MEDIA GROUP" and cannot decode half the charges. This makes looking feel futile and stressful. (O23; research.md mechanism M3 addresses this.)
...
P4: No calm space to just see subscriptions. Every app she has tried (even briefly) has felt overwhelming - too many numbers, too many graphs, too much emphasis on what she is doing wrong. (research/docs/ux-patterns.md BP1, competitors.md P2.)
...
- Showing value before asking for bank access. Even a demo with sample data that looks like her life would help. (research.md H1; benchmark.md C8.)
- Explicit plain-language explanation of what the product reads and why. "We read only recurring charge patterns. We cannot move money. Here is exactly what we access." (research.md M2; O20.)
- Real merchant names and logos (not bank codes) in any preview of the product. Recognizing Spotify and Netflix immediately signals "this understands me." (O23; research.md M3.)
...
### Persona 2 (SECONDARY): Ravi, 31 - The Privacy-First Non-Looker
...
Source: strategy.md Segment A2 JTBD; research.md J6; validated by ReSubs (O8), Bobby (O9)
...
Source: research.md J3; competitors.md (ReSubs 30+ cancel guides)
...
P2: Privacy-or-nothing binary. The market offers full bank access (Rocket Money, Emma) or full manual (Bobby). He is caught in the middle: he wants automation but will not pay with bank credentials. ReSubs' Gmail scan option introduces a different data concern (email access). (research/docs/competitors.md P3.)
...
P4: Hidden cancel complexity. Services he wants to cancel (gym, a streaming service, a SaaS tool) all have deliberately obscured cancellation flows. He has opened a tab to cancel and closed it frustrated. (competitors.md gap G4.)
...
- Explicit "no bank connection required" messaging, visible before he has to click anything. (O19; competitors.md P3.)
...
### Persona 3 (SECONDARY): Claudia, 36 - The Motivated Cutter
...
Source: research.md J3; competitors.md (ReSubs cancel guides, Rocket Money cancellation concierge)
...
P2: Cancellation dark patterns. Every service she wants to cancel requires navigating to a buried settings page, clicking through a retention flow, and sometimes calling a phone number. She has started cancellations and given up. (competitors.md gap G4; O26 shows 40% do cancel successfully, but the effort is real.)

P3: Feature overload in existing tools. She tried Rocket Money briefly and felt it wanted her to do too much - budgets, credit scores, net worth. She just wants the subscription list. (competitors.md P2.)
