...
### Our Approach
Build a mobile-first, desktop-responsive web app that reduces financial anxiety through calm, clear visibility of recurring spend. Not a budgeting app. Not a financial management suite. One job: show users what they pay for, simply and without judgment.
...
**v_refresh: Expanded to 15 competitors in 3 groups. Full detail in research/docs/competitors.md.**
...
Sources: research/docs/competitors.md v_refresh.
...
**P1: Bank connection as primary activation path.** All auto-detection competitors use bank linking as step 1. This is the fastest route to value but also the biggest trust barrier for the anxious user. Source: competitors.md P1.

**P2: Feature accumulation crowds out the core.** Every subscription tracker that gained scale expanded into full personal finance. The calm, simple subscription view is buried under feature depth. Source: competitors.md P2.

**P3: Privacy vs. convenience binary - no middle path offered.** Competitors force a binary choice: full bank access (Rocket Money/Emma/Hiatus) or fully manual (Bobby/ReSubs). No competitor offers a thoughtful middle path (e.g., AI screenshot import, email parsing, or partial connect). Source: competitors.md P3 (new in v_refresh).

### 3 Key Differences (v_refresh)

**D1: Revenue model shapes product incentives and culture.** Rocket Money earns from bill negotiation percentages. Emma earns from tiered subscriptions. ReSubs earns from lifetime purchases and IAP. These different models explain different product priorities - Rocket Money needs billable negotiations; ReSubs has no churn incentive to keep you subscribed. Source: competitors.md D1.
...
|-----|----------------|-------------|
| Calm as a first-class design principle | competitors.md P1/P2 | Core design principle #1 in CLAUDE.md |
| Plain language as a brand pillar | benchmark.md Monzo observation | Active voice + real merchant names in every string |
| Progressive trust-building before bank connection | competitors.md gap + benchmark C8 | Guided Reveal onboarding shows value before asking for bank access |
| The cancel moment as a designed positive emotional experience | competitors.md gap G4 | Cancel discovery = "win" moment; upgrade trigger; cancel guides as Pro feature |
| EU-native calm subscription tracker (simple, not full-finance) | competitors.md gap G5 | Cross-platform web-first, EU open banking support |
| Middle path between full bank connect and fully manual | competitors.md P3 + gap G6 (new v_refresh) | AI screenshot import / email parsing as path B; equal UX weight to bank connect path |
...
Source: research/docs/benchmark.md. Scores from public pages only; [? behind login] for app interiors.
...
2. **Fills the competitive gap.** No competitor has designed the first subscription view as an emotional experience. The Guided Reveal is directly analogous to Spotify Wrapped - a reveal of personal data as a satisfying moment. Source: research/docs/competitors.md gap #4, Phase 5 ux-patterns.md.
...
## Re-research for CJM (As-Is) - July 2026

Added during the CJM As-Is critique (Step 6) to close targeted [?] on Emma's As-Is journey. LITE mode, public / pre-login sources only.

**CJM-Q2 - The trigger moment in the user's voice (was [?]).** Public reporting confirms the surprise-charge trigger is experienced as shock and frustration, not neutral discovery. NBC News reports customers "fight surprise charges as online subscriptions surge"; a cited example: a customer found Adobe charging $14.99/month, $119 total, for a service used once and forgotten. First-person framing is common ("I forgot to cancel my subscription and now I have been charged"). This upgrades CJM As-Is Phase 2 (Trigger) from a drawn [?] to a sourced signal. It is a news-reported reaction, not a raw forum quote (LITE did not mine forums), so it is tagged signal, not pattern. Sources: [nbcnews.com/business/business-news/customers-fight-surprise-charges-online-subscriptions-surge-n1252149](https://www.nbcnews.com/business/business-news/customers-fight-surprise-charges-online-subscriptions-surge-n1252149), [quora.com](https://www.quora.com/I-forgot-to-cancel-my-subscription-and-now-I-ve-been-charged-Can-I-have-a-refund)

**CJM-Q3 - Verifying the self-image mechanism quote (was a LITE-summary paraphrase).** The "report card on your worth / if I look and it is bad, it means I am bad" phrasing did not appear verbatim on the named page. It is replaced with verified verbatim from the same financial-avoidance psychologist: people avoid looking because they "assume that what they find will confirm the worst about themselves", with the shame thoughts "I am irresponsible" and "I should have figured this out by now". This confirms and sharpens the P1 self-image mechanism already established by PMC/NCBI (Q2 Research above). Source: [maggiebakerphd.com/why-do-i-avoid-looking-at-my-bank-account-the-psychology-behind-financial-avoidance](https://maggiebakerphd.com/why-do-i-avoid-looking-at-my-bank-account-the-psychology-behind-financial-avoidance/)

**CJM-Q1 - The riskiest assumption (H0) stays open [?].** Whether a self-reported financial avoider completes a calm reveal and reports relief, rather than retreating at the friction pit, is not closeable by desk research. It requires the clickable-prototype test with 5-8 screened avoiders (strategy.md section 5). Carried as a known [?] in cjm-as-is.md.
