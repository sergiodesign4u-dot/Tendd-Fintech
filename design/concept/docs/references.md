...
**T3. Plain-language, active-voice rows.** Monzo's documented principle is "say who did the thing": "we blocked the payment" not "the payment was blocked" (benchmark.md Mechanism 1). Applied to alert and activity rows: "Spotify raised your price from $9.99 to $11.99 last month" not "a price change was detected."
...
*Next (Step 2): translate these techniques and the founder's recorded taste into 3 to 5 attribute pairs, each with a source line, in design/concept/docs/concept.md.*
